...
const ApplicationsList = () => {
    ...
    const filterApplications = (application) => {
        const formationDate = new Date(application.date_creating);
        ...
        if (selectedStatus && application.meter_status !== selectedStatus) {
            return false;
        }
    ...
    return (
        <div>
            ...
            <tbody>
                ...
                <tr key={application.water_meter_reading_id}>
                    <td>{application.water_meter_reading_id}</td>
